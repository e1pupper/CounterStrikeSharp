...
SH_DECL_HOOK7_void(IServerGameClients, ProcessUsercmds, SH_NOATTRIB, 0, int, CPlayerSlot, bf_read*, int, bool, bool, float);
...
void PlayerManager::OnShutdown()
{
    ...
    globals::callbackManager.ReleaseCallback(m_on_client_process_usercmds_callback);
}
